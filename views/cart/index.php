...
<div id="wrapper">
    <div id="content_insidecart">
        <div id="sidebar">
            ...
            <ul id="list">
                <?php foreach($categories as $categoryItem): ?><div class="test">
        ...
        <div id="main_block">
            <div class="about">
                <div class="tes">
                <p ><h3><div class="cart">CART</div></h3></p><br><br>
                ...
                <table class =" table-bordered table-striped table">
                    ...
                    <?php foreach($products as $i => $product): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/cart/delete/<?php echo $product['id']; ?>"><img src="/template/images/DELETE.png" alt="" width="16" height="16"></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    <tr>
