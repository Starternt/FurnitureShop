            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="" method="post" enctype="multipart/form-data"> <!-- enctype необходим для отправки изображения -->
                        <p>Название товара</p>
                        <input type="text" name="name" placeholder="Наименование" value="<?php echo $product['name']; ?>">
                        <p>Артикул</p>
                        <input type="text" name="code" placeholder="Артикул" value="<?php echo $product['code']; ?>">
                        <p>Стоимость $</p>
                        <input type="text" name="price" placeholder="Стоимость" value="<?php echo $product['price']; ?>">
                        <p>Категория</p>
